 ...
 */
public class SpecExcerciseFragment extends Fragment {

    int iloscWykonanych = 9;
    int ileDoWYkonania = 9;
    int maxWykonanych = 10; // do pobrania z bazy
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spec_excercise, container, false);
